...
awful.spawn.with_shell('~/.screenlayout/multiple-personal.sh')     							                -- Load screen layout config on boot
...
local function set_wallpaper()
    awful.spawn.with_shell('feh --bg-scale ~/wallpapers/win-11-01.jpg')
end
